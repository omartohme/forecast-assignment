...
document.addEventListener("DOMContentLoaded", function() {
  ...
  css.setAttribute("href", "css/weather-icons-master/livecss/weather-icons.css");
...
function buildWidget(cls) {
  var myKey = "ed5baca8d637c1f2b7deb732fc92a214";
  var latitude = "45.348391";
  var longitude = "-75.757045";
  $.ajax({
    url: "https://api.forecast.io/forecast/" + myKey + "/" + latitude + "," + longitude + "?units=ca",
    type: "GET",
    dataType: "jsonp",
    ...
    error: function() {
      alert("Watch out, something went wrong..")
    }
  })
}
